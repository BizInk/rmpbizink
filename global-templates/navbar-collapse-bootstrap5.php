...
<nav id="main-nav" class="navbar navbar-expand-xl navbar-dark" aria-labelledby="main-nav-label">
	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		<?php $main_logo = get_field('site_logo','option') ?>
	...
	<?php	}
		...
		$talk_to_us_link = get_field('talk_to_us_link', 'options');

		if( !empty($talk_to_us_link['url']) && !empty($talk_to_us_link['title']) ){ ?>

			<a href="<?= $talk_to_us_link['url']; ?>" target="<?= $talk_to_us_link['target']; ?>" class="btn header-btn"><?= $talk_to_us_link['title']; ?></a>
		<?php } ?>
