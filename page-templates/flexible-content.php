...
$global_theme_color1 = get_field('global_theme_color1', 'option') ? get_field('global_theme_color1', 'option') : '#003d73';
$global_theme_color2 = get_field('global_theme_color2', 'option') ? get_field('global_theme_color2', 'option') : '#232323';
$global_theme_color3 = get_field('global_theme_color3', 'option') ? get_field('global_theme_color3', 'option') : '#ffffff';
$global_theme_color4 = get_field('global_theme_color4', 'option') ? get_field('global_theme_color4', 'option') : '#008dff';
$global_theme_color5 = get_field('global_theme_color5', 'option') ? get_field('global_theme_color5', 'option') : '#AAAAAA';
$global_theme_color6 = get_field('global_theme_color6', 'option') ? get_field('global_theme_color6', 'option') : '#2A7FC2';
$global_theme_color7 = get_field('global_theme_color7', 'option') ? get_field('global_theme_color7', 'option') : '#93BEE0';
  ...
  while( have_rows('page_flexible_content') ): the_row();
    if( get_row_layout() == 'info_box' ):
      ...
      elseif( get_row_layout() == 'two_column_content' ):
        get_template_part('page-templates/template-parts/two-column-content');
      ...
      elseif( get_row_layout() == 'google_reviews' ):
        get_template_part('page-templates/template-parts/google_reviews');
