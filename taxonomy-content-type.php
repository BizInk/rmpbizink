...
<section class="four-col-team-section blog-listing-section comman-padding greadiant-bg content-type-section">
                    ...
                    <div class="col-md-6 col-xl-4 blog <?= $counter; ?>" <?= $counter > $ppp ? 'style="display:none;"' : ''; ?> data-pagenumber="resources<?= ceil($counter/$ppp); ?>">
                        <div class="blog-inner-wrap">
                            ...
                            <div class="blog-details">
                                ...
                                <div class="meta">
                                    <span class="posted-on"><?php echo get_the_date('d M, Y'); ?></span>| <span class="author"><?php the_author(); ?></span>
                                </div>
