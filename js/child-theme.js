	...
	jQuery(document).ready(function ($) {
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      var memberdetails = 0; //for the description section
	      //Calculating the description new height

	      jQuery('.member-word').each(function () {
	        if (memberdetails < jQuery(this).outerHeight()) {
	          memberdetails = jQuery(this).outerHeight();
	        }
	      }); //Calculating the description new height

	      jQuery('.member-word').css({
	        'min-height': memberdetails
	      });
	    });
	  }
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      var teamwrap = 0; //for the description section
	      //Calculating the description new height

	      jQuery('.member-details h6').each(function () {
	        if (teamwrap < jQuery(this).outerHeight()) {
	          teamwrap = jQuery(this).outerHeight();
	        }
	      }); //Calculating the description new height

	      jQuery('.member-details h6').css({
	        'min-height': teamwrap
	      });
	    });
	  }
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      var description = 0; //for the description section
	      //Calculating the description new height

	      jQuery('.meta-desciption + p').each(function () {
	        if (description < jQuery(this).outerHeight()) {
	          description = jQuery(this).outerHeight();
	        }
	      }); //Calculating the description new height

	      jQuery('.meta-desciption + p').css({
	  ...
	  if (jQuery(window).width() > 767) {
	    jQuery(window).on('load resize', function () {
	      var topic = 0; //for the topic section
	      //Calculating the topic new height

	      jQuery('.content-topic-section .description').each(function () {
	        if (topic < jQuery(this).outerHeight()) {
	          topic = jQuery(this).outerHeight();
	        }
	      }); //Calculating the topic new height

	      jQuery('.content-topic-section .description').css({
	        'min-height': description
	      });
	    });
	  }
